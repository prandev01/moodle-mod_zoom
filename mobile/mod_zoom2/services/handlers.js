 ...
 * @ngdoc service
 * @name $mmaModZoom2Handlers
 */
  .factory('$mmaModZoom2Handlers', function($mmCourse, $mmaModZoom2, $state, $mmContentLinksHelper) {
    var self = {};
     ...
     * @module mm.addons.mod_zoom2
     * @ngdoc method
     * @name $mmaModZoom2Handlers#courseContentHandler
     */
    self.courseContentHandler = function() {
      ...
      self.getController = function(module, courseId) {
        return function($scope) {
		  ...
		  $scope.icon = 'addons/mod/zoom2/icon.gif'
     ...
     * @ngdoc method
     * @name $mmaModZoom2Handlers#linksHandler
     */
